...
public abstract class Message
{
    ...
    public static class Dispatcher extends SimpleChannelInboundHandler<Request>
    {
        ...
        private static final class DirectFlusher extends Flusher
        {
            private DirectFlusher(EventLoop eventLoop)
            {
                super(eventLoop);
            }
        ...
        private void flush(FlushItem item)
        {
            ...
            if (flusher == null)
            {
                Flusher created = useLegacyFlusher ? new LegacyFlusher(loop) : new DirectFlusher(loop);
